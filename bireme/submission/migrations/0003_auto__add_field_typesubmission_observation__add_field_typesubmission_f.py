...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TypeSubmission.observation'
        db.add_column('submission_typesubmission', 'observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'TypeSubmission.file'
        db.add_column('submission_typesubmission', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=510, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TypeSubmission.observation'
        db.delete_column('submission_typesubmission', 'observation')

        # Deleting field 'TypeSubmission.file'
        db.delete_column('submission_typesubmission', 'file')
    ...
    models = {
        ...
        'submission.bibliographictype': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 15, 46, 10, 233423)'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 15, 46, 10, 233464)'}),
