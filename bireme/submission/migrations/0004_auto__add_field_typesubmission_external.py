...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TypeSubmission.external'
        db.add_column('submission_typesubmission', 'external', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['center.ExternalDatabase'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TypeSubmission.external'
        db.delete_column('submission_typesubmission', 'external_id')
    ...
    models = {
        ...
        'submission.bibliographictype': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 18, 12, 46, 44, 973253)'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 18, 12, 46, 44, 973284)'}),
