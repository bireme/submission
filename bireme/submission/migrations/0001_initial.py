...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('submission_step', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 27, 18, 35, 2, 251091))),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 27, 18, 35, 2, 251120))),
        ...
        db.create_table('submission_typesubmission', (
            ...
            ('iso_file', self.gf('django.db.models.fields.files.FileField')(max_length=510, null=True, blank=True)),
            ...
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=510, null=True, blank=True)),
            ('external', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['center.ExternalDatabase'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'submission.bibliographictype': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 18, 35, 2, 251091)'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 18, 35, 2, 251120)'}),
