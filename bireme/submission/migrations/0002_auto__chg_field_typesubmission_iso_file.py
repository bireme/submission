...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeSubmission.iso_file'
        db.alter_column('submission_typesubmission', 'iso_file', self.gf('django.db.models.fields.files.FileField')(max_length=510, null=True))


    def backwards(self, orm):
        
        # Changing field 'TypeSubmission.iso_file'
        db.alter_column('submission_typesubmission', 'iso_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'submission.bibliographictype': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 31, 17, 32, 37, 713388)'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 31, 17, 32, 37, 713431)'}),
